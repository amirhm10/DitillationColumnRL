# Converted from OnlineTrainingNoDist5.ipynb
...
warm_start = 10
ACTOR_FREEZE = 16 * set_points_len
...
Q_diag = np.array([120000.0, 30000.0])
R_diag = np.array([100.0, 100.0])

y_band_phys = np.array([0.5e-4, 0.05])
...
params, reward_fn = make_reward_fn_fixed_QR(
        ...
        Q_diag, R_diag,
        tau_frac=0.7,
        gamma_out=1.2, gamma_in=1.2,
        beta=140., gate="geom", lam_in=1.0,
        bonus_kind="exp", bonus_k=16.0, bonus_p=0.6, bonus_c=20.0)
print(params)
...
save_path = os.path.join(dir_path, r"C:\Users\HAMEDI\Desktop\DistillRL\Data\dl_no_disturb\20251105_135455\input_data.pkl")
with open(save_path, 'rb') as file:
